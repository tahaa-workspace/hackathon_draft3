      ...
      {records.length === 0 ? (
        ...
        <div className="space-y-2">
          ...
          {records.map((doc) => (
            ...
            <div
              key={doc.id}
              className="rounded-xl border border-ink-100 px-3 py-3"
            >
  ...
  const load =
    useCallback(async () => {
      ...
      try {
        ...
        setError(
          err.message ||
          'Unable to load assigned Legacy Access Claims.'
        );
  ...
  */
  ...
  const requestInfo =
    async (claim) => {
      ...
      const message =
        window.prompt(
          'What additional document, information, or clearer evidence is required?',
          ''
        ) ?? null;
  ...
  */
  ...
  const reject =
    async (claim) => {
      ...
      const remarks =
        window.prompt(
          'State the professional reason for rejecting this claim.',
          ''
        ) ?? null;
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-ink-100 bg-white px-4 py-3 shadow-sm">
              ...
              <button
                ...
                aria-label="Toggle Lawyer availability"
              >
          ...
          <div className="space-y-5">
            ...
            {visibleClaims.map(
              (claim) => {
                ...
                const records =
                  claim.assignedRecords ||
                  claim.assignedDocuments ||
                  [];
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3 border-b border-ink-100 bg-ink-50/50 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs text-ink-400">
                          Professional Legacy Access Review · {claim.id}
                        </p>
                      ...
                      <div>
                        ...
                        {records.length === 0 ? (
                          ...
                          <p className="mt-3 rounded-xl bg-amber-50 p-3 text-sm text-amber-700">
                            No assigned records were found.
                            Do not approve until clarified.
                          </p>
                    ...
                    {claim
                      ...
                      <div className="border-t border-ink-100 bg-orange-50/40 px-5 py-4">
                            ...
                            .map(
                              (request) => (
                                ...
                                <div
                                  ...
                                  className="rounded-xl border border-orange-100 bg-white p-3 text-sm"
                                >
                    ...
                    {claim.status ===
                      ...
                      <div className="flex flex-wrap justify-end gap-2 border-t border-ink-100 bg-ink-50/30 px-5 py-4">
                        ...
                        <button
                          ...
                          className="rounded-lg border border-orange-200 px-3 py-2 text-xs font-semibold text-orange-700 hover:bg-orange-50"
                        >
                    ...
                    {claim
                      ...
                      <div className="border-t border-ink-100 px-5 py-3 text-sm text-ink-600">

                        <span className="font-semibold">
                          Latest professional remarks:
                        </span>{' '}
